...
| General/Photo model | REAL | Real-ESRGAN NCNN Vulkan, user-installed trusted runtime |
| Local engine installation | REAL | Explicit folder import; fixed files copied and hashed; existing installation preserved |
...
| Dark / Light / System | REAL | Persisted theme, system color-scheme listener, keyboard focus styles |
...
| Portrait / face / anime / text / restore models | DEFERRED | No unique specialist processing claimed |
| Hardware utilization / VRAM / benchmarks | DISABLED | No fabricated metrics |
